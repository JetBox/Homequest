...
class Event_LivingRoom(Event):
    ...
    def generate_flavor_text(self):
        ...
        if not self.player.previous_location:
            ...
            self.initial_entry()
            flavor_text += "You are " + self.player.name + ", and you are ready to begin your quest... your Homequest. The world is your oyster. But beware! The world is rife with danger, and if you aren't careful you could lose your life!\n\n"
        elif not self.player.previous_location == self.__class__.__name__:
            flavor_text += "You walk into your living room.\n\n"
            
        # generate text describing what is in your living room, if applicable
        flavor_text += "The room is completely empty of all furniture and objects. You should probably buy some furniture once you get more money.\n\n"
        
        # generate text depending on where the player can go
        flavor_text += "From here, you can go upstairs to your bedroom. You can also head to your kitchen, or to your guest room. You can also leave your house via the front door.\n\n"
