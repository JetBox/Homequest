...
class Event_Kitchen(Event):
    ...
    def generate_flavor_text(self):
        ...
        if self.player.previous_location != self.__class__.__name__:
            flavor_text.append(Colorful_Text("You enter your kitchen.\n\n"))

        # generate text describing what is in your living room, if applicable
        flavor_text.append(Colorful_Text("Your kitchen has all you could ever need. You have a fridge and freezer filled to the brim with snacks and various ingredients for cooking. You have a pantry that contains cereals, canned soups, dry pasta, etc. You have an oven with a stove over it, as well as a microwave and a sink.\n\n"))
        ...
        flavor_text.append(Colorful_Text("If you're feeling bold, you can try to cook something.\n\n"))
